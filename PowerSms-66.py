...
┌─────────────────────────────────────────────────────┐   
│[✔] DEVELOPER  :            SADMAN SAMIR SNIGDHO                                                        
│[✔] FACEBOOK   :            Sadman Samir                    
│[✔] GITHUB     :            SNIGDHO-CYBER404         
...
def sms_bombing():
    os.system('clear')
    os.system('xdg-open https://youtube.com/channel/UCNrAJeSmceaiE5yV06gySrA')
    print logo
    print ""
...
def intro():
    ...
    print ""
    user_choise = raw_input("\033[1;34msamir \033[1;31m>>  ")
    if user_choise == "1":
       sms_bombing()
    elif user_choise == "2":
         os.system('xdg-open https://m.facebook.com/devilsnigdho.00')
         os.system('xdg-open https://youtube.com/channel/UCNrAJeSmceaiE5yV06gySrA')
    elif user_choise == "3":
         os.system('clear')
